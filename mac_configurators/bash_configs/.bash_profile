...
# <!>-Version-NA
export DROID_HOME=${HOME}/sdk/Android
# <!>-Version-NA
...
export PATH=$PSHOME:$HOME/.jenv/bin:$PATH:/usr/local/sbin:${GCP_CLI_HOME}/bin:${SFCC_CI_HOME}:${JAVA_HOME}/bin:${ANT_HOME}/bin:${CATALINA_HOME}/bin:${DROID_TOOLS}:${M2_HOME}/bin:${SOLR_HOME}/bin:${JETTY_HOME}/bin:${CASSA_HOME}/bin:${BREW_PREFIX}/bin:${BREW_PREFIX}/sbin:${MONGO_HOME}/bin:${JMETER_HOME}/bin
...
export PATH=$PATH:/Users/viva/.local/bin:/Applications/Sublime\ Text.app/Contents/SharedSupport/bin
